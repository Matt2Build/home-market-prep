      ...
      <section className="relative overflow-hidden bg-[#111111] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 px-6 py-12 sm:py-14 lg:grid-cols-[1.08fr,0.92fr] lg:items-center">
          <div>
            ...
            <p className="text-[11px] leading-6 text-white/40">Seller prep guidance by Matt Salit · 425-645-2181 · mattsalit@writemyoffer.com · Century 21 North Homes Realty</p>
